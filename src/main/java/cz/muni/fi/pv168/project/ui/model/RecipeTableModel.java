...
public class RecipeTableModel extends AbstractTableModel {
    ...
    private final List<Column<Recipe, ?>> columns = List.of(
            Column.editable("Title", String.class, Recipe::getTitle, Recipe::setTitle),
            Column.editable("Description", String.class, Recipe::getDescription, Recipe::setDescription)
    );
